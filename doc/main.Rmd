...
# MSD + combine
# pred_movie_msd_combine <- avg_dev_pred(movie_train,movie_test,movie_msd, movie_msd_combine)
...
# PC + combine
# pred_movie_pc_combine <- avg_dev_pred(movie_train,movie_test,movie_pc, movie_pc_combine)
```
